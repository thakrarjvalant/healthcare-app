# Healthcare App - Sequential Container Rebuild Script
# Builds containers one by one to avoid resource contention

Write-Host "🚀 Healthcare App - Sequential Container Rebuild" -ForegroundColor Green
...
Write-Host "`n✨ Build process completed!" -ForegroundColor Green# Healthcare App - Sequential Container Rebuild Script
# Builds containers one by one to avoid resource contention
