...
class UserSeeder
{
    ...
    {
        $this->db->exec("DELETE FROM users WHERE email IN ('john.doe@example.com', 'jane.smith@example.com', 'bob.receptionist@example.com', 'admin@example.com', 'medical.coordinator@example.com')");
    }
}